...
namespace Magecomp\Instagrampro\Block\Adminhtml\Proindex\Edit\Renderer;
...
class Thumbnail extends AbstractElement
{
    protected $blockdata;
    protected $request;
    ...
    public function __construct(
        ...
        Homepage $blockdata,
        Http $request,
        InstagramproimageFactory $InstagramproimageFactory
    ) {
        $this->blockdata = $blockdata;
        $this->request = $request;
        $this->InstagramproimageFactory = $InstagramproimageFactory;
    ...
    public function getAfterElementHtml()
    {
        ...
        $html = '';
        if ($this->getValue()) {
            $html = '<strong>Simply drag and drop each pin to automatically set top and left positions for each hotspot.</strong>';
            $html .= '<div onMouseOver="move_init();" class="image-div" id="image-div" style="height:525px; width:500px;"><img id="' . $this->getHtmlId() . '_image" style="border: 1px solid #d6d6d6;margin-top:20px" title="' . $this->getValue() . '" src="' . $this->getValue() . '" alt="' . $this->getValue() . '" width="525" height="525" />';

            $html .= '<img onmousedown="_move_item(this);" class="hotspot-img" id="hotspot6" src="' . $this->blockdata->getViewFileUrl('Magecomp_Instagrampro::images/6.png') . '" alt="hotspot icon">';

            $html .= '<img onmousedown="_move_item(this);" class="hotspot-img" id="hotspot5" src="' . $this->blockdata->getViewFileUrl('Magecomp_Instagrampro::images/5.png') . '" alt="hotspot icon">';

            $html .= '<img onmousedown="_move_item(this);" class="hotspot-img" id="hotspot4" src="' . $this->blockdata->getViewFileUrl('Magecomp_Instagrampro::images/4.png') . '" alt="hotspot icon">';

            $html .= '<img onmousedown="_move_item(this);" class="hotspot-img" id="hotspot3" src="' . $this->blockdata->getViewFileUrl('Magecomp_Instagrampro::images/3.png') . '" alt="hotspot icon">';

            $html .= '<img onmousedown="_move_item(this);" class="hotspot-img" id="hotspot2" src="' . $this->blockdata->getViewFileUrl('Magecomp_Instagrampro::images/2.png') . '" alt="hotspot icon">';

            $html .= '<img onmousedown="_move_item(this);" class="hotspot-img" id="hotspot1" src="' . $this->blockdata->getViewFileUrl('Magecomp_Instagrampro::images/1.png') . '" alt="hotspot icon">';
