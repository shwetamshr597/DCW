    ...
    public function execute()
    {
        ...
        if (!empty($captchaError)) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__("If there is an account associated with %1 you 
                will receive an email with a link to reset your password.",$this->escaper->escapeHtml($email)));
