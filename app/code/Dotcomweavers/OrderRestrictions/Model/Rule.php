...
class Rule extends AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'dotcomweavers_orderRestrictions';
    ...
    {
        parent::_construct();
        $this->_init(\Dotcomweavers\OrderRestrictions\Model\ResourceModel\Rule::class);
        $this->setIdFieldName('restriction_id');
    }
