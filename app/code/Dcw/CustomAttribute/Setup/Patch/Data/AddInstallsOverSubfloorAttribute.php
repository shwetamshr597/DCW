...
class AddInstallsOverSubfloorAttribute implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $attribute_code = 'installs_over_subfloor';
