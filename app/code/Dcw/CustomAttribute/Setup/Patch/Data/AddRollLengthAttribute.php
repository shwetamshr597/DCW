...
class AddRollLengthAttribute implements DataPatchInterface
{
    /**
        ...
        if (!$attribute || !$attribute->getAttributeId()) {
            $eavSetup->addAttribute(
                ...
                [
                    ...
                    'option' => [
                        'values' => [
                            0=>"4' x 4' - Standard Grade",
                            1=>"4' x 6' - Standard grade",
                            2=>"5' x 12' - Standard grade",
                            3=>"5' x 17' - Standard grade"
                        ],
                     ]
                ]
            );
