...
class AddWearLayerThicknessAttribute implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $attribute_code = 'wear_layer_thickness';
        ...
        if (!$attribute || !$attribute->getAttributeId()) {
            $eavSetup->addAttribute(
                ...
                [
                    ...
                    'backend' => '',
                    'frontend' => '',
                    'label' => 'Wear Layer Thickness (mil)',
                    'input' => 'text',
                    'class' => '',
                    'source' => '',
