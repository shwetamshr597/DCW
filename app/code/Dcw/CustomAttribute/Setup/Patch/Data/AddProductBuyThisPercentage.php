...
class AddProductBuyThisPercentage implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    public const GROUPCODE = "General";

    public const ATTRIBUTE_SET_ID = "Default";
    ...
    public function apply()
    {
        ...
        $attribute_code = 'buy_this_percentage';
