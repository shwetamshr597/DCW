...
class AddApproximateTileSizeAttribute implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $attribute_code = 'approximate_tile_size';
