 ...
 */
class ProductList extends \Hyva\Theme\ViewModel\ProductList
{
    /**
    ...
    public function getCrosssellItems(QuoteItem ...$cartItems): array
    {
		...
		$this->maxCrosssellItemCount = (int)$this->getConfigValue1('catalog/magento_targetrule/crosssell_position_limit');
